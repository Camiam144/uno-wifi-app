...
impl Delay {
    ...
    // This is a really poor implementation of a delay, I should probably
    // set up something for a clock timer
    #[inline]
...
impl DelayNs for Delay {
    ...
    fn delay_ms(&mut self, ms: u32) {
        let cycles = (ms as u64 * self.sysclk_freq as u64 / 1_000) as u32;
        self.delay_cycles(cycles.max(1));
    }
}
